        ...
        <!-- Javascripts -->
        <script src="{{HTML::script('assets/plugins/jquery/jquery-2.1.3.min.js')}}"></script>
        <script src="{{HTML::script('assets/plugins/jquery-ui/jquery-ui.min.js')}}"></script>
        <script src="{{HTML::script('assets/plugins/pace-master/pace.min.js')}}"></script>
        <script src="{{HTML::script('assets/plugins/jquery-blockui/jquery.blockui.js')}}"></script>
        <script src="{{HTML::script('assets/plugins/bootstrap/js/bootstrap.min.js')}}"></script>
        <script src="{{HTML::script('assets/plugins/jquery-slimscroll/jquery.slimscroll.min.js')}}"></script>
        <script src="{{HTML::script('assets/plugins/switchery/switchery.min.js')}}"></script>
        <script src="{{HTML::script('assets/plugins/uniform/jquery.uniform.min.js')}}"></script>
        <script src="{{HTML::script('assets/plugins/offcanvasmenueffects/js/classie.js')}}"></script>
        <script src="{{HTML::script('assets/plugins/offcanvasmenueffects/js/main.js')}}"></script>
        <script src="{{HTML::script('assets/plugins/waves/waves.min.js')}}"></script>
        <script src="{{HTML::script('assets/plugins/3d-bold-navigation/js/main.js')}}"></script>
        <script src="{{HTML::script('assets/plugins/waypoints/jquery.waypoints.min.js')}}"></script>
        <script src="{{HTML::script('assets/plugins/jquery-counterup/jquery.counterup.min.js')}}"></script>
        <script src="{{HTML::script('assets/plugins/toastr/toastr.min.js')}}"></script>
        <script src="{{HTML::script('assets/plugins/flot/jquery.flot.min.js')}}"></script>
        <script src="{{HTML::script('assets/plugins/flot/jquery.flot.time.min.js')}}"></script>
        <script src="{{HTML::script('assets/plugins/flot/jquery.flot.symbol.min.js')}}"></script>
        <script src="{{HTML::script('assets/plugins/flot/jquery.flot.resize.min.js')}}"></script>
        <script src="{{HTML::script('assets/plugins/flot/jquery.flot.tooltip.min.js')}}"></script>
        <script src="{{HTML::script('assets/plugins/curvedlines/curvedLines.js')}}"></script>
        <script src="{{HTML::script('assets/plugins/metrojs/MetroJs.min.js')}}"></script>
        <script src="{{HTML::script('assets/js/modern.min.js')}}"></script>
        <script src="{{HTML::script('assets/js/pages/dashboard.js')}}"></script>
