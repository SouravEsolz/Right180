			@include('admin.adminheader')<!-- Include Header-->
            @include('admin.adminsidenav')<!-- Include Sidebar-->
                                    ...
                                    <div class="inbox-widget slimscroll">
                                        <a href="#">
                                            <div class="inbox-item">
                                                <div class="inbox-item-img"><img src="{{URL::asset('assets/images/avatar2.png')}}" class="img-circle" alt=""></div>
                                        ...
                                        <a href="#">
                                            <div class="inbox-item">
                                                <div class="inbox-item-img"><img src="{{URL::asset('assets/images/avatar3.png')}}" class="img-circle" alt=""></div>
                                        ...
                                        <a href="#">
                                            <div class="inbox-item">
                                                <div class="inbox-item-img"><img src="{{URL::asset('assets/images/avatar4.png')}}" class="img-circle" alt=""></div>
                                        ...
                                        <a href="#">
                                            <div class="inbox-item">
                                                <div class="inbox-item-img"><img src="{{URL::asset('assets/images/avatar5.png')}}" class="img-circle" alt=""></div>
